  ...
  return (
    <main className="legal-page container">
      ...
      <section className="legal-section">
        ...
        <p>
          Si dejas tu email en el formulario del kit de presupuesto freelance, ese dato se usara
          para darte acceso al recurso y para avisarte de futuras actualizaciones directamente
